<?php
     ...
     * or use the CheckboxColumnClick to detect a change to a checkbox.
     *
     ...
     * @property string $CheckboxClass Default null. The CSS class to apply to the div tag.
     *
     * @package QCubed\Plugin
     */
    class VauuColumn extends DataColumn
    {
        /** @var bool|null */
        ...
        protected ?string $strCheckboxClass = null;
        ...
        public function fetchHeaderCellValue(): string
        {
            if ($this->blnShowCheckAll) {
                ...
                if ($this->strCheckboxClass) {
                    $attributes['class'] = $this->strCheckboxClass;
                } else {
                    $attributes = null;
                }

                $strHtml = Html::renderTag('input', $aParams, null, true);
                return Html::renderTag('div', $attributes, $strHtml  . '<label></label>');
            } else {
                return $this->Name;
            }
        }
        ...
        public function __set(string $strName, mixed $mixValue): void
        {
            switch ($strName) {
                ...
                case "CheckboxClass":
                    try {
                        $this->strCheckboxClass = Type::cast($mixValue, Type::STRING);
                        break;
                    } catch (InvalidCast $objExc) {
                        $objExc->incrementOffset();
                        throw $objExc;
