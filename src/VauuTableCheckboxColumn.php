<?php
     ...
     * Class VauuColumn
     *
     * A checkbox column that specifically is for inclusion in a VauuTable object. The two work together to hand off
     ...
     */
    class VauuTableCheckboxColumn extends VauuColumn
    {
        ...
        /**
         * Retrieves the unique checkbox ID for the given item.
         *
         * @param mixed $item The item for which the checkbox ID is to be generated.
         *
         * @return string The unique checkbox ID.
         */
